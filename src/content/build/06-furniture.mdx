...
The mattress is a 10-inch [Endy](https://www.endy.com/products/rv-mattress?size=Short+Queen) memory foam, which is 100% overkill but totally awesome. I think a good 6-inch mattress would probably also be fine, but anything less than that I would be a bit skeptical.
...
<img src="/images/van-build/storage-slider-cubby-800.jpg" alt="The angled open cubby above the sliding door" class="float-right ml-6 mb-4 w-1/2 rounded-lg" />
